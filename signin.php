			...
			<div class="l-part">
				<form action="" method="post">
					...
					<div class="overlap-text">
						...
						<a style="text-decoration:none;float: right;color: #187FAB;" data-toggle="tooltip" title="Reset Password" href="forgot_password.php"></a>
					</div>
					<div style="margin-bottom: 25px" class="input-group">
                        <label for="jawaban">Pertanyaan keamanan<a style="color:red">*</a> <br>
                        <?= $int1 ?> +
                        <?= $int2 ?>
                        = ?
                    </div></label>
					<input class="jwb" type="number" id="jawaban" name="jawaban" required><br><br>
